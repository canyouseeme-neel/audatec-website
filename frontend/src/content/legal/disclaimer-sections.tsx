...
export const disclaimerSections: LegalSection[] = [
  {
    ...
    body: (
      <>
        <p>The information provided by <strong>Audatec</strong> (&quot;Company&quot;, &quot;we&quot;, &quot;our&quot;, &quot;us&quot;) on <strong>audatec.in</strong> (the &quot;Site&quot;) is for general informational purposes only. All information on the Site is provided in good faith, however we make no representation or warranty of any kind, express or implied, regarding the accuracy, adequacy, validity, reliability, availability, or completeness of any information on the Site.</p>
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p>For example, the outlined <ExtLink href="https://policymaker.io/disclaimer/">Disclaimer</ExtLink> has been created using <ExtLink href="https://policymaker.io/">PolicyMaker.io</ExtLink>, a free web application for generating high-quality legal documents. PolicyMaker&apos;s <ExtLink href="https://policymaker.io/disclaimer/">disclaimer generator</ExtLink> is an easy-to-use tool for creating an excellent sample Disclaimer template for a website, blog, eCommerce store or app.</p>
  ...
  },
  {
    ...
    body: (
      <>
        <p>While we have made every attempt to ensure that the information contained in this site has been obtained from reliable sources, Audatec is not responsible for any errors or omissions or for the results obtained from the use of this information. All information in this site is provided &quot;as is&quot;, with no guarantee of completeness, accuracy, timeliness or of the results obtained from the use of this information, and without warranty of any kind, express or implied, including, but not limited to warranties of performance, merchantability, and fitness for a particular purpose.</p>
        <p>In no event will Audatec, its related partnerships or corporations, or the partners, agents or employees thereof be liable to you or anyone else for any decision made or action taken in reliance on the information in this Site or for any consequential, special or similar damages, even if advised of the possibility of such damages.</p>
      </>
    ),
  },
  {
    ...
    body: (
      <p>All logos and trademarks of third parties referenced on audatec.in are the trademarks and logos of their respective owners. Any inclusion of such trademarks or logos does not imply or constitute any approval, endorsement or sponsorship of Audatec by such owners.</p>
    ),
  },
  {
    heading: "Contact Us",
    body: (
      <p>Should you have any feedback, comments, requests for technical support or other inquiries, please contact us by email: <strong>hello@audatec.in</strong>.</p>
    ),
  },
];
