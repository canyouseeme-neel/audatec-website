...
export const privacySections: LegalSection[] = [
  {
    ...
    body: (
      <>
        <p>Welcome to Audatec.</p>
        <p>
          Audatec (&quot;us&quot;, &quot;we&quot;, or &quot;our&quot;) operates audatec.in (hereinafter referred to as &quot;Service&quot;).
        </p>
        <p>
          Our Privacy Policy governs your visit to audatec.in, and explains how we collect, safeguard and disclose information that results from your use of our Service.
        </p>
        <p>
  ...
  },
  {
    ...
    body: (
      <>
        <p><strong>SERVICE</strong> means the audatec.in website operated by Audatec.</p>
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p>
          While using our Service, we may also collect the following information: sex, age, date of birth, place of birth, passport details, citizenship, registration at place of residence and actual address, telephone number (work, mobile), details of documents on education, qualification, professional training, employment agreements, <ExtLink href="https://policymaker.io/non-disclosure-agreement/">NDA agreements</ExtLink>, information on bonuses and compensation, information on marital status, family members, social security (or other taxpayer identification) number, office location and other data.
        </p>
      </>
    ),
  },
  {
    ...
    body: (
      <>
        <p>Audatec uses the collected data for various purposes:</p>
        <ol>
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p>Audatec will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
      </>
    ),
  },
  {
    ...
    body: (
      <>
        ...
        <p><strong>Business Transaction.</strong> If we or our subsidiaries are involved in a merger, acquisition or asset sale, your Personal Data may be transferred.</p>
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p>If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at <strong>hello@audatec.in</strong>.</p>
  ...
  {
    heading: "11. Your Data Protection Rights under CalOPPA",
    body: (
      <>
        ...
        <ul>
          ...
          <li>users are able to change their personal information by emailing us at <strong>hello@audatec.in</strong>.</li>
        </ul>
        <p>Our Policy on &quot;Do Not Track&quot; Signals: We honor Do Not Track signals and do not track, plant cookies, or use advertising when a Do Not Track browser mechanism is in place. Do Not Track is a preference you can set in your web browser to inform websites that you do not want to be tracked. You can enable or disable Do Not Track by visiting the Preferences or Settings page of your web browser.</p>
      </>
    ),
  },
  {
    heading: "12. Your Data Protection Rights under the California Consumer Privacy Act (CCPA)",
    body: (
      <>
        ...
        <p>To exercise your California data protection rights described above, please send your request(s) by email: <strong>hello@audatec.in</strong>.</p>
  ...
  {
    heading: "16. Behavioral Remarketing",
    body: (
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p>For example, the outlined <ExtLink href="https://policymaker.io/privacy-policy/">privacy policy</ExtLink> has been made using <ExtLink href="https://policymaker.io/">PolicyMaker.io</ExtLink>, a free tool that helps create high-quality legal documents. PolicyMaker&apos;s <ExtLink href="https://policymaker.io/privacy-policy/">privacy policy generator</ExtLink> is an easy-to-use tool for creating a <ExtLink href="https://policymaker.io/blog-privacy-policy/">privacy policy for blog</ExtLink>, website, e-commerce store or mobile app.</p>
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    body: (
      <p>If you have any questions about this Privacy Policy, please contact us by email: <strong>hello@audatec.in</strong>.</p>
    ),
  },
];
